...
The following diagram illustrates the high level architecture of Tecton feature platform.
...
Tecton is the hosted SaaS feature platform. It includes Feast feature store.
