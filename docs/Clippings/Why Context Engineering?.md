...
- Task ID
- Search query
- Status (todo, in\_progress, completed)
- Results summary
- Timestamp
...
Learn how to build production-ready AI agents in our comprehensive course. [Join now!](https://academy.dair.ai/courses/building-effective-ai-agents) Use code PROMPTING20 to get an extra 20% off.
